...
* Tilegod expansion
* Super Guide removal (toggleable)
...
* 1-1 Peach's Castle BG removal (toggleable)
* 2-Castle Maze removal (toggleable)
* Always skip cutscenes with plus
* NewerSMBW styled pregame (toggleable)
...
* Player 1 Can Change Character (toggleable)
* Bomb Bro actor
* Removal of stage timer + live counter (toggleable)
* Rotation controlled coin hacks
* Newer-esque file select (toggleable)
* Fake Star Coin actor
* Effect/SFX Spawner actor
* Galoomba actors
* Quick Restart (toggleable)
...
* Classic + GameCube controller support (toggleable)
* Splunkin actor
* Magic Platform actor
* Debug menu scene (toggleable)
* SMW Flip Block actor
* 2D Maps (Koopatlas port) (toggleable)
* Expanded Snake Blocks

### Planned Features
These features are planned to be implemented in the future.
* Petey Pirahna Boss actor
* Level Names/Info (toggleable)
* Triple ? Block actor
* Hammer Suit/More Powerups (toggleable)
* More Characters (toggleable)
* Region Free utilites (toggleable)
* Dynamic Discord RPC (toggleable)
