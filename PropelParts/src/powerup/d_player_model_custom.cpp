...
const int dPlayerMdlCustom_c::scPropelRollBaseSpeed = 0x400;

dPlayerMdlCustom_c::dPlayerMdlCustom_c(u8 val) : dPyMdlBase_c(val),
...
dPlayerMdlCustom_c::~dPlayerMdlCustom_c() {}

void dPlayerMdlCustom_c::createModel() {
    getPlayerObjectRes();
    createPlayerModel();
    mMotionShareScale.x = mMotionShareScale.y = mMotionShareScale.z = getAimMotionShareScale();
}

void dPlayerMdlCustom_c::initialize() {
    for (int i = 0; i < 5; i++) {
...
void dPlayerMdlCustom_c::getPlayerObjectRes() {
...
void dPlayerMdlCustom_c::createPlayerModel() {
...
void dPlayerMdlCustom_c::calc2() {
    m_208 = 2;
    getBodyMdl()->setLocalMtx(&mBaseMtx);
    getBodyMdl()->calc(false);
}

void dPlayerMdlCustom_c::play() {
    setStarEffect();
    calcStoopOffset();
...
void dPlayerMdlCustom_c::setInitTexAnm() {
    nw4r::g3d::ResAnmTexPat pat = m_20c.GetResAnmTexPat("PH_wait");
    _setHeadTexAnm(pat, m3d::FORWARD_LOOP, 0.0f, 0.0f);
}

void dPlayerMdlCustom_c::_setHeadTexAnm(nw4r::g3d::ResAnmTexPat &anmTexPat, m3d::playMode_e playMode, float rate, float frame) {
...
const dPyMdlBase_c::TexAnmData_s dPlayerMdlCustom_c::scTexAnmData[TEX_ANM_COUNT] = {
...
void dPlayerMdlCustom_c::setTexAnmType(TexAnmType_e anmType) {
...
void dPlayerMdlCustom_c::resetTexAnmType() {
...
m3d::anmTexPat_c &dPlayerMdlCustom_c::getHeadTexAnm() {
    ...
    } else if (mPyPlayerMode == (PlayerMode_e)4) {
        return mTexAnmHammer;
    } else {
        return mTexAnm2;
    }
}

bool dPlayerMdlCustom_c::setPersonalRideAnm(int anmID, nw4r::g3d::ResAnmChr *outAnmChr) {
...
bool dPlayerMdlCustom_c::setPersonalAnm(int anmID, nw4r::g3d::ResAnmChr *outAnmChr, int p3) {
    char anmNameBuf[32];
...
bool dPlayerMdlCustom_c::getJumpAnmName(int jumpType, char *anmNameBuf, int p4) {
...
void dPlayerMdlCustom_c::copyAnm() {
...
void dPlayerMdlCustom_c::_setFootAnm(nw4r::g3d::ResAnmChr &anmChr, m3d::playMode_e playMode, float rate, float frame, float p5) {
...
void dPlayerMdlCustom_c::_setBodyAnm(nw4r::g3d::ResAnmChr &anmChr, m3d::playMode_e playMode, float rate, float frame, float p5) {
    nw4r::g3d::ResMdl mdl = m_20c.GetResMdl(mpArcNames->mModelNameBody[mPyPlayerMode]);
...
void dPlayerMdlCustom_c::setAnmBind() {
    nw4r::g3d::ResMdl mdl = m_20c.GetResMdl(mpArcNames->mModelNameBody[mPyPlayerMode]);
...
void dPlayerMdlCustom_c::FUN_800d4750(int mode) {
    mOtherPlayerMode = mPyPlayerMode;
    mPyPlayerMode = (PlayerMode_e) mode;
}

void dPlayerMdlCustom_c::setPlayerMode(int mode) {
    static const int l_player_model_dt[] = { 1, 0, 0, 1, 2, 3, 0, 4 };
...
void dPlayerMdlCustom_c::setColorType(u8 type) {}

void dPlayerMdlCustom_c::setDark(int value) {
...
bool dPlayerMdlCustom_c::getHeadPropelJointMtx(mMtx_c *mtx) {
    if (mPyPlayerMode == PLAYER_MODE_PROPELLER) {
...
void dPlayerMdlCustom_c::onStarAnm() {
    if (!isStarAnm()) {
...
void dPlayerMdlCustom_c::offStarAnm() {
    if (isStarAnm()) {
...
void dPlayerMdlCustom_c::changeLightTexture(m3d::mdl_c *mdl, _GXTexMapID texMapID) {
...
void dPlayerMdlCustom_c::setStarAnm(m3d::mdl_c *mdl, m3d::anmMatClr_c *matClr) {
    changeLightTexture(mdl, GX_TEXMAP3);
    mdl->setAnm(*matClr);
}

void dPlayerMdlCustom_c::removeStarAnm(m3d::mdl_c *mdl) {
...
void dPlayerMdlCustom_c::calcBlendRate() {
...
void dPlayerMdlCustom_c::callbackTimingA(nw4r::g3d::ChrAnmResult *anmRes, nw4r::g3d::ResNode resNode) {
...
void dPlayerMdlCustom_c::nodeCallback_c::timingA(ulong nodeId, nw4r::g3d::ChrAnmResult *anmRes, nw4r::g3d::ResMdl resMdl) {
    mpOwner->callbackTimingA(anmRes, resMdl.GetResNode(nodeId));
}

void dPlayerMdlCustom_c::nodeCallback_c::timingB(ulong nodeId, nw4r::g3d::WorldMtxManip *manip, nw4r::g3d::ResMdl resMdl) {
...
void dPlayerMdlCustom_c::nodeCallbackPLH_c::timingA(ulong nodeId, nw4r::g3d::ChrAnmResult *anmRes, nw4r::g3d::ResMdl resMdl) {}

void dPlayerMdlCustom_c::nodeCallbackPLH_c::timingB(ulong nodeId, nw4r::g3d::WorldMtxManip *manip, nw4r::g3d::ResMdl resMdl) {
    if (nodeId != 1) {
        return;
    }
    mMtx_c mtx;
...
void dPlayerMdlCustom_c::setStarEffect() {
    if (!(m_17c & 0x200)) {
        return;
    }
